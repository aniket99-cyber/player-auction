...
const COLORS =[
  '#f82', '#d73', '#b64', '#8a4', '#4e4', '#3c3', '#282', '#161', '#0a0', '#000',
  '#0bf', '#09a', '#078', '#055', '#032', '#018', '#000', '#000', '#000', '#000',
  '#fb0', '#d8a', '#b57', '#7d3', '#4d1', '#2e1', '#1a0', '#090', '#050', '#000',
  '#0fb', '#0c8', '#078', '#045', '#021', '#010', '#000', '#000', '#000', '#000',
  '#b0f', '#9a0', '#740', '#4e0', '#2e0', '#1a0', '#090', '#050', '#020', '#000',
  '#f0b', '#d89', '#b55', '#7d2', '#4c1', '#2a1', '#171', '#0d1', '#060', '#000',
  '#bf0', '#9c0', '#7b0', '#4a0', '#2d0', '#1b0', '#090', '#040', '#010', '#000'
]
